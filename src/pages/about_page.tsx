...
We are taking action
  ...
  <div className='main4'  style={{ backgroundImage: isDark ? `url('https://amplify-amplifya785c969872c4-staging-111600-deployment.s3.amazonaws.com/vision_render1.jpg')` : `url('https://amplify-amplifya785c969872c4-staging-111600-deployment.s3.amazonaws.com/vision_render1.jpg')`, background: 'no-repeat', backgroundSize: "cover",
